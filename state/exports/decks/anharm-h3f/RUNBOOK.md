# H3F — RTSC Im-3m BCC hydride 런북 (BUILD 산출물 · INFRA-READY)

> Im-3m (SG 229) BCC H3F, isostructural to Im-3m H3S. 압력 200 GPa.
> H @ 6b symmetrized-bond 위치 — H3S 의 high-symmetry 메커니즘 클래스.

## 1. 구조

- 공간군: **Im-3m (SG 229)**, BCC — H3S prototype
- QE ibrav = 3 (BCC primitive), nat = 4 (1 F + 3 H), ntyp = 2
- F @ 2a (0,0,0), H @ 6b (1/2,0,0)/(0,1/2,0)/(0,0,1/2)
- 목표 압력: **200 GPa**
...
| 원소 | UPF | 라이브러리 |
|------|-----|-----------|
| F | `F.pbe-n-rrkjus_psl.1.0.0.UPF` | PSL 1.0.0 (PBE) — main-group, 란타나이드 이슈 없음 |
