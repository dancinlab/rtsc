#!/usr/bin/env bash
# CoSn HOLE-doping scan driver (tot_charge POSITIVE = remove electrons → E_F down → flat band toward E_F) — QE tot_charge jellium proxy.
# hole Δp ∈ {0,0.2,0.4,0.6} → tot_charge = {0,+0.2,+0.4,+0.6}  (positive = REMOVE electrons).
...
DOPINGS=("0.0:0.0" "h0.2:0.2" "h0.4:0.4" "h0.6:0.6")
