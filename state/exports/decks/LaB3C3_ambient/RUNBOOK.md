# LaB3C3 — RTSC Pm-3n boron-carbon clathrate runbook (BUILD output)

> Boron-carbon SODALITE clathrate, cubic Pm-3n (SG #223), 14-atom cell
>   (2 La + 6 B + 6 C). MgB2-like sigma-bonded covalent SC — NO hydrogen.
> Reference: Zhu/Strobel et al. arXiv:1708.03483 (SrB3C3, lambda~0.9-1.0,
...
> Pseudos auto-fetched (PSL 1.0.0): La · B.pbe-n · C.pbe-n. La = spfn (d13 f-states).
